...
namespace ExamService.Controllers
{
    ...
    public class LessonController : Controller
    {
        ...
        {
            var lessons = _context.Lessons.Where(x=>x.UserId == GetUser.Id 
        ...
        {
            var lesson = _context.Lessons.Where(x => x.Guid == id 
            && x.UserId == GetUser.Id 
        ...
        public ActionResult Edit(LessonViewModel model)
        {
            try
            {
                var lesson = _context.Lessons.Where(x => x.Guid == model.Guid && x.UserId == GetUser.Id).FirstOrDefault();
                if (model.Name != "")
                {
        ...
        {
            var lesson = _context.Lessons.Where(x => x.Guid == id && x.UserId == GetUser.Id).FirstOrDefault();
            if (lesson != null)
            {
                return View(new LessonViewModel
                {
        ...
        {
            return Json(_context.Lessons.Where(x => x.UserId == GetUser.Id && x.Delete == false)
        ...
        {
            return Json(_context.Subjects.Where(x => x.Delete == false
                                                && x.Lesson.Guid == guid
        ...
        public IActionResult EditSubject(int subjectId, string subjectName)
        {
            try
            {
                var sub = _context.Subjects.Where(x => x.Id == subjectId && x.Lesson.UserId == GetUser.Id).FirstOrDefault();
        ...
        {
            var questionCount = _context.QuestionPools.Where(x => x.SubjectId == subjectId && x.Lesson.UserId == GetUser.Id).Count();
